var cal = {
    ...
    list : function () {
        ...
        for (var i=0; i<total; i++) {
            ...
            if (squares[i]=="b") { cCell.classList.add("blank"); }
                ...
                cCell.innerHTML = "<div class='dd' id='day-"+squares[i]+"' onclick='cal.show("+squares[i]+")'>"+squares[i]+"</div>";
    ...
    show : function (day) {
        ...
        $.ajax({
            url: '/appointments/list?day='+day+'&month='+(cal.sMth+1)+'&year='+cal.sYear,
            method: 'GET',
        ...
        $("#day-"+day).closest('td').addClass('active');
